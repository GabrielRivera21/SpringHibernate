...
public class OAuth2SecurityConfiguration {
	...
	private static final String RESOURCE_ID = "SpringHibernate";
	...
	protected static class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
		...
		@Autowired
		private SpringHibernateUserDetailsService userDetails;
		...
		public void configure(HttpSecurity http) throws Exception {
			...
			http.anonymous()
				...
				.antMatchers("/sdoc.jsp", "/swagger-ui.js", "swagger-ui.min.js",
						...
						UsersSvcApi.USERS_FORGOTPASS_PATH).permitAll();
						
			//TODO: Temporary Path, To be removed in production
			http.anonymous()
			.and()
			.authorizeRequests()
				.antMatchers(UsersSvcApi.USERS_CHANGEPASS_PATH).permitAll();
	...
	protected static class OAuth2Config extends AuthorizationServerConfigurerAdapter {
		...
		public OAuth2Config() throws Exception {
			...
			.scopes("read").resourceIds("users", "SpringHibernate")
			.and().build();

			 
			UserDetailsService svc = new SpringHibernateUserDetailsService();
